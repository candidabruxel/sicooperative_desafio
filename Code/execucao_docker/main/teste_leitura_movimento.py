...
from tabela.leitura_tabela import ler_tabela_movimento
...
class TestLeituraTabelaMovimento(unittest.TestCase):
    def setUp(self):
        self.spark = MagicMock()

    def test_ler_tabela_Movimento(self):
        result = ler_tabela_movimento(self.spark, url, properties)
